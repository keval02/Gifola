...
public class AESEncryptionDecryptionAlgorithm {
    ...
    private static AESEncryptionDecryptionAlgorithm instance = null;

    AESEncryptionDecryptionAlgorithm(String key) {
        try {
    ...
    public static AESEncryptionDecryptionAlgorithm getInstance(String key) {
        if (instance == null) {
            instance = new AESEncryptionDecryptionAlgorithm(key);
        }

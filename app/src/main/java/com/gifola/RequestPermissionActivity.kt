...
import com.gifola.adapter.RequestCheckInListAdapter
...
class RequestPermissionActivity : AppCompatActivity() {
    ...
    private fun fetchid() {
        checkInListAdapter = object : RequestCheckInListAdapter(this, checkInList, checkInListAll) {
    ...
    private fun setupToolbar() {
        ...
        txt_title!!.text = "Request Permisssion/CHECKIN"
    ...
    private fun getUserInfo(number: String, name: String, favorite: Int) {
        bar?.hide()
